            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="${pageContext.request.contextPath}/" class="logo d-flex align-items-center w-auto">
                  <span class="d-none d-lg-block">다이어리</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate>
                    ...
                    <%-- 
                    <div class="col-12">
                      <p class="small mb-0">계정이 없으신가요? <a href="${pageContext.request.contextPath}/DIALG02">계정만들기</a></p>
                    </div>
                    --%>
  ...
  <script>
    $(document).ready(function() {
    	$("#btnLogin").click(function() {
    		...
    		ajax('DIALG05', requestMap, function(response) {
