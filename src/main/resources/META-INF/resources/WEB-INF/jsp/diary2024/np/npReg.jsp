	...
	<main id="main" class="main">
        <div class="mt-5 mb-3">
	        <div class="form-check form-check-inline col-sm-2">
	            <input class="form-check-input" type="radio" name="notePostPtDtcd" id="notePostPtDtcd01" value="01" checked>
	            <label class="form-check-label" for="notePostPtDtcd01">일상</label>
	        </div>
	        <div class="form-check form-check-inline col-sm-2">
	            <input class="form-check-input" type="radio" name="notePostPtDtcd" id="notePostPtDtcd02" value="02">
	            <label class="form-check-label" for="notePostPtDtcd02">식단</label>
	        </div>
	        <div class="form-check form-check-inline col-sm-2">
	            <input class="form-check-input" type="radio" name="notePostPtDtcd" id="notePostPtDtcd03" value="03">
        ...
        <!-- 제목 입력 -->
        <div class="mb-3">
            <input type="text" class="form-control" id="notePostTit" name="notePostTit" placeholder="제목을 입력해주세요" autocomplete="off">
        </div>
		<div id="editor"></div>
	...
	<script>
		...
		$(document).ready(function () {
			...
			$('#btnRegister').click(function() {
		    	...
		    	alertUtils.showConfirm('게시글을 등록하시겠습니까?', function() {
			    	var requestMap = {
			    	...
			    	ajax('DIANP02', requestMap, function(response) {
			...
			$('#btnCancle').click(function() {
				alertUtils.showConfirm('저장하지 않고 등록을 취소하시겠습니까?', function() {
					gotoURL('DIANP03');
				});
			});
		});
