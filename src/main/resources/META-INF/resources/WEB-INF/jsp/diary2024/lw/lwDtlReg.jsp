	...
	<main id="main" class="main">
        <div class="mt-5 mb-3">
	        <div class="form-check form-check-inline col-sm-2">
	            <input class="form-check-input" type="radio" name="lgwkNotePostDtlPtDtcd" id="lgwkNotePostDtlPtDtcd01" value="01" checked>
        ...
        <!-- 제목 입력 -->
        <div class="mb-3">
            <input type="text" class="form-control" id="lgwkNotePostDtlTit" name="lgwkNotePostDtlTit" placeholder="제목을 입력해주세요" autocomplete="off">
        </div>
		<div id="editor"></div>
	...
	<script>
		...
		$(document).ready(function () {
			...
			$('#btnRegister').click(function() {
		    	...
		    	alertUtils.showConfirm('회차를 등록하시겠습니까?', function() {
			    	var requestMap = {
			    	...
			    	ajax('DIALW09', requestMap, function(response) {
