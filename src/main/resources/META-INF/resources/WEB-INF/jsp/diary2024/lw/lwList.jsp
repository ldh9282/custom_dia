    	...
    	<section class="section">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="card">
						<div class="card-body">
							<h5 class="card-title">장편게시글 조회</h5>
							<form id="defaultForm">
								<p>
								...
								<input type="hidden" id="theLgwkNotePostSno" name="lgwkNotePostSno" value="${requestMap.lgwkNotePostSno}">
							</form>
							<form id="searchForm">
							...
							<div class="row">
								<div class="col-md-3">
									<div class="input-group mb-3">
									    ...
									    <input type="text" class="form-control" id="lgwkNotePostSno" name="lgwkNotePostSno" value="${requestMap.lgwkNotePostSno}" autocomplete="off">
									</div>
								</div>
							</div>
							<div class="row">
							...
							<table class="table mt-3">
								...
								<tbody id="tbody">
									<c:choose>
										...
										<c:otherwise>
										<c:forEach var="lw" varStatus="lwStatus" items="${lwList}">
											<tr>
												...
												<td class="text-center" >
													<c:out value="${lw.lgwkNotePostSno}" />
												</td>
												<td class="text-center">
													<a class="title-link" href="javascript:gotoURL('DIALW04?lgwkNotePostSno=${lw.lgwkNotePostSno}');">
														<c:out value="${lw.lgwkNotePostTit}" />
													</a>
												</td>
												<td class="text-center" >
													<c:out value="${lw.sysModifier}" />
												</td>
												<td class="text-center" >
													<c:out value="${lw.sysCreatedAt.substring(0, 10) == today ? lw.sysCreatedAt.substring(10, 16) : lw.sysCreatedAt.substring(0, 10)}" />
												</td>
											</tr>
	...
	<script>
		...
		$(document).ready(function() {
			...
			$("#theRowAmountPerPage").change(function() {
				...
				formSubmit($('#defaultForm'), 'DIALW03');
			})
