	...
	<main id="main" class="main">
        <div class="mt-5 mb-3">
	        <div class="form-check form-check-inline col-sm-2">
	            <input class="form-check-input" type="radio" name="lgwkNotePostPtDtcd" id="lgwkNotePostPtDtcd01" value="01" checked>
        ...
        <!-- 제목 입력 -->
        <div class="mb-3">
            <input type="text" class="form-control" id="lgwkNotePostTit" name="lgwkNotePostTit" placeholder="제목을 입력해주세요" autocomplete="off">
        </div>
		<div id="editor"></div>
		...
		$(document).ready(function () {
			...
			$('#btnRegister').click(function() {
		    	...
		    	alertUtils.showConfirm('게시글을 등록하시겠습니까?', function() {
			    	...
			    	ajax('DIALW02', requestMap, function(response) {
